window.addEventListener('load',
  (event) => {
    ...
    <div id="unhcr-overlay-internal-content">
      ...
      <p>
      Η δωρεά σας θα βοηθήσει την Ύπατη Αρμοστεία του ΟΗΕ για τους Πρόσφυγες (UNHCR) να στηρίξει οικογένειες που έχουν πληγεί από την κρίση στην Ουκρανία, προσφέροντας στέγη και προστασία.
      </p>

      </div>
      <div class="unhcr-overlay-cta">
        Μαζί στεκόμαστε δίπλα σε αυτούς που μας χρειάζονται. 
      </div>
...
function openModal(modal, openAnyway) {
  if (openAnyway) {
